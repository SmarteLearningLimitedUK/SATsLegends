...
const captures = [
  { name: 'Place Value Panic', url: `${baseUrl}/game/1/1`, path: `${outputsDir}/arithmetic-place-value-panic-iphone-latest.png` },
  { name: 'Number Line Ninja', url: `${baseUrl}/game/1/2`, path: `${outputsDir}/arithmetic-number-line-ninja-iphone-latest.png` },
  { name: 'Prime Pop', url: `${baseUrl}/game/1/3`, path: `${outputsDir}/arithmetic-prime-pop-iphone-latest.png` },
  { name: 'Rounding Rocket', url: `${baseUrl}/game/1/4`, path: `${outputsDir}/arithmetic-rounding-rocket-iphone-latest.png` },
];
...
const dismissPracticeIntro = async (page) => {
...
for (const capture of captures) {
  ...
  await dismissPracticeIntro(page);
