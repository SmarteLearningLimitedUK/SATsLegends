...
// Trigger a correct answer to show boost
const answerButtons = page.locator('button', { hasText: '/' });
if (await answerButtons.count()) {
  await answerButtons.first().click();
  await page.waitForTimeout(400);
}

await page.screenshot({ path: 'qa/ratio-fractions-game-iphone-boost.png' });
await browser.close();
