...
import iconBrainpowerToken from '../assets/casual_ui/icons/brainpowertoken.png';
...
const ICONS = {
  ...
  back: iconBack,
  next: iconNext,
  brainpowerToken: iconBrainpowerToken,
  star: iconBrainpowerToken,
  starOutline: iconBrainpowerToken,
  question: iconHelp,
  check: iconCheck,
  trophy: iconTrophy,
  timer: iconTimer,
