  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden bg-[linear-gradient(180deg,#102a55_0%,#1d4ed8_34%,#0f172a_100%)]">
      ...
      <div className="relative z-10 flex h-full min-h-0 w-full flex-1 flex-col items-center gap-2 p-2 md:gap-4 md:p-4">
        ...
        <div className="relative flex w-full max-w-6xl flex-1 min-h-0 overflow-hidden rounded-[2rem] border border-white/12 bg-[linear-gradient(180deg,rgba(7,18,32,0.16),rgba(7,18,32,0.38))] shadow-[0_28px_70px_rgba(2,6,23,0.28)] md:rounded-[2.6rem]">
