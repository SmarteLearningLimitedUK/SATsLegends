...
const AvatarSelect: React.FC<AvatarSelectProps> = ({ selectedId, onSelect, onConfirm }) => {
  ...
  return (
    <div className="relative my-auto flex h-full max-h-full w-full max-w-6xl flex-col gap-1.5 overflow-hidden px-3 py-2 md:gap-3 md:px-8 md:py-6">
      ...
      />
      <div className="absolute inset-x-3 top-0 bottom-0 -z-10 rounded-[2rem] border border-[#f3cf78]/28 bg-[linear-gradient(180deg,rgba(255,244,213,0.04),rgba(255,255,255,0.01)),linear-gradient(180deg,rgba(10,18,35,0.54),rgba(7,11,22,0.72))] shadow-[inset_0_1px_0_rgba(255,237,186,0.12),0_28px_90px_rgba(2,6,23,0.42)] backdrop-blur-[22px] md:inset-x-8 md:rounded-[2.8rem]" />
