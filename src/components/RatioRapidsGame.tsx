            ...
            <div className="relative mt-3 flex min-h-0 flex-1 flex-col justify-between md:mt-4">
              <div className="relative flex min-h-[19rem] flex-1 items-center justify-center overflow-hidden md:min-h-[25rem]">
                ...
                <div className="absolute inset-x-[9%] bottom-[10%] top-[26%]">
                  ...
                  <div className="absolute left-[52%] bottom-[40%] h-[18%] w-[3%] rounded-full bg-[linear-gradient(180deg,#8b5cf6,#6d28d9)]" />
              ...
              <div className="mt-2 rounded-[1.8rem] border border-white/12 bg-[linear-gradient(180deg,rgba(15,23,42,0.84),rgba(30,41,59,0.92))] p-3 shadow-[0_24px_36px_rgba(2,6,23,0.26)] md:p-4">
                <div className="grid grid-cols-1 gap-3 md:grid-cols-[1fr_1fr_auto] md:items-center">
                  ...
                  <button
                    ...
                    className="licensed-submit-button flex min-w-[11rem] items-center justify-center rounded-[1.5rem] px-5 py-4 text-lg font-black text-white disabled:opacity-45 md:min-w-[13rem] md:rounded-[1.8rem] md:text-2xl"
                  >
