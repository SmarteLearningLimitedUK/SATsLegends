...
export const ISLAND_BLUEPRINTS: IslandBlueprint[] = [
  {
    ...
    miniGames: [
      ...
      },
      {
        ...
        difficultyCurve: '3-digit rounding -> 6-7 digit place-value rounding -> decimal precision rounds',
      ...
      },
      {
        ...
        failureState: 'security failure after repeated incorrect rounds',
  ...
  },
  {
    ...
    miniGames: [
      ...
      },
      {
        ...
        keySystems: ['trend cue overlays', 'interval pick prompts', 'change-rate challenge rounds'],
      ...
      },
      {
        ...
        mechanicSummary: 'Use the Data Detective case format for suspect-solving rounds built from chart clues and comparisons.',
  ...
  },
  {
    ...
    miniGames: [
      ...
      },
      {
        ...
        difficultyCurve: 'guided reasoning -> combined clues -> high-pressure paper rounds',
