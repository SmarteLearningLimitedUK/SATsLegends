  ...
  },
  {
    ...
    miniGames: [
      ...
      },
      {
        ...
        name: 'Change Counter',
        role: 'application',
        gameplayRoles: ['application', 'fluency'],
        mechanicSummary: 'Work out the exact change to give back in quick shop scenarios.',
        curriculumObjectives: ['money', 'change', 'subtraction', 'real_world_problem_solving'],
        keySystems: ['paid vs cost comparison', 'exact change validation', 'money sense pacing'],
        questionTypes: ['change from amount paid', 'pounds and pence subtraction'],
        difficultyCurve: 'whole pounds -> mixed pounds and pence -> larger totals and trickier pence',
        failureState: 'incorrect change given',
        replayValue: 'rotating money scenarios with varied totals',
      },
      {
        key: 'perimeter_path',
        name: 'Perimeter Path',
