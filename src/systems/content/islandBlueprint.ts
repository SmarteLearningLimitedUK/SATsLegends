  ...
  },
  {
    ...
    miniGames: [
      ...
      },
      {
        ...
        name: 'Whodunnit Data',
        role: 'mixed_mastery',
        gameplayRoles: ['mixed_mastery', 'strategy', 'application'],
        mechanicSummary: 'Solve detective cases by reading one to three graphs and matching clues to the correct suspect.',
        ...
        keySystems: ['suspect evidence matching', 'single-to-multi graph progression', 'instant accusation feedback'],
        questionTypes: ['direct value lookup', 'most/fewest comparisons', 'multi-clue suspect identification'],
        difficultyCurve: 'single graph clues -> comparison language -> two-graph links -> three-graph reasoning cases',
        failureState: 'wrong suspect accusation',
        replayValue: 'procedural suspect stats and case clues',
      },
    ],
  },
  {
