  ...
  graph_grabber: [
    {
      minLevel: 1,
      value: {
        prompt: 'The records show the number of crates carried by each supply caravan. How many crates did the Number Caravan deliver?',
        sublabel: 'Read the Number Caravan stack carefully.',
        options: ['4', '6', '7', '9'],
        answerIndex: 1,
        visual: {
          type: 'bars',
          ...
          bars: [
            { label: 'Number Caravan', value: 6, color: 'from-sky-400 to-cyan-300' },
            { label: 'Logic Caravan', value: 9, color: 'from-indigo-400 to-blue-300' },
            { label: 'Brain Caravan', value: 7, color: 'from-emerald-400 to-lime-300' },
            { label: 'Data Caravan', value: 4, color: 'from-amber-300 to-yellow-300' },
          ],
        },
      },
    },
    {
      ...
      value: {
        ...
        options: ['Number Caravan', 'Logic Caravan', 'Brain Caravan', 'Data Caravan'],
        answerIndex: 1,
        visual: {
          type: 'bars',
          caption: 'Supply caravans',
    ...
    },
    {
      minLevel: 2,
      value: {
        prompt: 'The records show the number of crates carried by each supply caravan. How many more crates did the Logic Caravan deliver than the Brain Caravan?',
        sublabel: 'Subtract the Brain Caravan stack from the Logic Caravan stack.',
        options: ['2', '3', '4', '5'],
        answerIndex: 1,
        visual: {
          type: 'bars',
          caption: 'Supply caravans',
          bars: [
            { label: 'Number Caravan', value: 5, color: 'from-sky-400 to-cyan-300' },
            { label: 'Logic Caravan', value: 12, color: 'from-indigo-400 to-blue-300' },
            { label: 'Brain Caravan', value: 9, color: 'from-emerald-400 to-lime-300' },
            { label: 'Data Caravan', value: 4, color: 'from-amber-300 to-yellow-300' },
          ],
        },
      },
    },
    {
      ...
      value: {
        ...
        visual: {
          ...
          caption: 'Supply caravans',
          bars: [
            { label: 'Number Caravan', value: 7, color: 'from-sky-400 to-cyan-300' },
            { label: 'Logic Caravan', value: 8, color: 'from-indigo-400 to-blue-300' },
            { label: 'Brain Caravan', value: 5, color: 'from-emerald-400 to-lime-300' },
            { label: 'Data Caravan', value: 6, color: 'from-amber-300 to-yellow-300' },
          ],
        },
      },
    },
