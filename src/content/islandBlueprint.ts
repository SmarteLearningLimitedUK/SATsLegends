...
export const ISLAND_BLUEPRINTS: IslandBlueprint[] = [
  ...
  },
  {
    ...
    miniGames: [
      ...
      },
      {
        ...
        role: 'strategy',
        gameplayRoles: ['strategy', 'mixed_mastery'],
        mechanicSummary: 'Complete linked ratio relationships where one incorrect value breaks the chain.',
        curriculumObjectives: ['equivalent_ratios', 'missing_value_proportion', 'ratio_reasoning'],
        skillTags: ['RATIO_EQUIVALENT', 'PROPORTION'],
        keySystems: ['linked dependency nodes', 'cascade validation', 'chain-break feedback'],
        questionTypes: ['missing proportional values', 'equivalent chain completion'],
        difficultyCurve: 'single link -> multi-link chains -> timed cascading systems',
        failureState: 'incorrect link breaks the system chain',
        replayValue: 'dynamic linked ratio networks',
      },
      {
        key: 'scale_builder',
        name: 'Scale Builder',
      ...
      },
      {
        ...
        mechanicSummary: 'Rapid-fire ratio rounds where quick, exact decisions sustain streak momentum.',
        curriculumObjectives: ['applied_ratio_fluency', 'sharing_ratio_application', 'proportion_speed'],
        skillTags: ['RATIO_SHARE', 'RATIO_SCALE', 'RATIO_EQUIVALENT', 'PROPORTION'],
        keySystems: ['streak tracking', 'time-pressure clock', 'penalty windows on misses'],
        questionTypes: ['rapid ratio outcomes', 'fast share/scale decisions'],
        difficultyCurve: 'short bursts -> mixed rapid rounds -> high-pressure mastery sprint',
        failureState: 'streak break and time loss',
        replayValue: 'high-score pursuit with rotating mixed-skill prompts',
      },
    ],
  },
  {
    ...
    crossGameReinforcement: [
      'transformation fluency is reinforced across Rotation Relay, Reflection Rescue, and Translation Tracker',
      'positioning skills are reinforced across Coordinates Quest and Translation Tracker',
    ...
    miniGames: [
      ...
      },
      {
        ...
        role: 'application',
        gameplayRoles: ['application', 'strategy'],
        mechanicSummary: 'Reflect shapes across interactive mirror lines to rescue target placements.',
        curriculumObjectives: ['reflection', 'mirror_symmetry', 'axis_awareness'],
        skillTags: ['REFLECTION'],
        keySystems: ['interactive mirror-line control', 'live mirrored preview', 'position lock checks'],
        questionTypes: ['mirror line mapping', 'reflect across vertical/horizontal/diagonal lines'],
        difficultyCurve: 'single-axis reflection -> varied axis reflection -> chained reflect-and-place tasks',
        failureState: 'incorrect mirrored position',
        replayValue: 'dynamic mirror-line layouts',
      },
      {
        ...
        mechanicSummary: 'Move objects on a grid using vector instructions while managing constraints.',
        curriculumObjectives: ['translation', 'vector_movement', 'coordinates'],
        skillTags: ['TRANSLATION', 'COORDINATES'],
        keySystems: ['grid movement parser', 'obstacle tiles', 'limited move budget'],
        questionTypes: ['move by vector instruction', 'reach destination under constraints'],
        difficultyCurve: 'single translation -> chained vectors -> constrained obstacle routes',
        failureState: 'incorrect final position or move exhaustion',
        replayValue: 'generated pathing tasks with variable obstacles',
      },
      {
  ...
  },
  {
    ...
    miniGames: [
      ...
      },
      {
        ...
        name: 'Builder Bay',
        role: 'strategy',
        gameplayRoles: ['strategy', 'concept_visualisation', 'application'],
        mechanicSummary: 'Build layouts to match target areas while minimising wasted space.',
        curriculumObjectives: ['area_rectangles', 'compound_area', 'spatial_coverage'],
        skillTags: ['AREA', 'COMPOUND_AREA'],
        keySystems: ['tile placement', 'coverage validation', 'waste-space penalties'],
        questionTypes: ['build to target area', 'compound area composition'],
        difficultyCurve: 'simple rectangles -> compound layouts -> constrained multi-zone builds',
        failureState: 'incorrect coverage or wasted space beyond tolerance',
        replayValue: 'procedural build blueprints and target zones',
      },
      {
        key: 'volume_vault',
        name: 'Volume Vault',
      ...
      },
      {
        ...
        name: 'Measure Mix-Up',
        role: 'mixed_mastery',
        gameplayRoles: ['mixed_mastery', 'application', 'pressure_timing'],
        mechanicSummary: 'Resolve chained real-world measurement challenges across mixed unit and shape systems.',
        curriculumObjectives: ['measurement_reasoning', 'multi_step_measurement', 'applied_measure_chains'],
        skillTags: ['MEASURE_MULTI_STEP', 'UNIT_CONVERSION', 'TIME', 'AREA', 'PERIMETER', 'VOLUME'],
        keySystems: ['challenge chains', 'intermediate state carry-over', 'final outcome verification'],
        questionTypes: ['convert-build-verify sequences', 'mixed measure application scenarios'],
        difficultyCurve: 'single-domain tasks -> two-step mixed tasks -> SATs-style mixed mastery chains',
        failureState: 'incorrect final result',
        replayValue: 'rotating multi-step challenge sets',
      },
    ],
  },
  {
    ...
    crossGameReinforcement: [
      'comparison is reinforced across Data Dash, Data Detective, and Chart Challenge',
    ...
    miniGames: [
      {
        ...
        name: 'Data Dash',
        role: 'pressure_timing',
        gameplayRoles: ['pressure_timing', 'application'],
        mechanicSummary: 'Move through lanes and choose the correct route from live data prompts.',
        curriculumObjectives: ['chart_reading', 'value_comparison', 'fast_data_decisions'],
        skillTags: ['DATA_BAR_CHART', 'DATA_LINE_GRAPH', 'DATA_COMPARE'],
        keySystems: ['lane choice timing', 'slowdown penalties', 'streak recovery'],
        questionTypes: ['pick lane from chart', 'fast greater/less comparisons'],
        difficultyCurve: 'clear lane choices -> tighter windows -> dense mixed chart lane decisions',
        failureState: 'wrong lane triggers slowdown penalty',
        replayValue: 'generated lane-data scenarios',
      },
      {
        key: 'graph_grabber',
        name: 'Graph Grabber',
  ...
  },
  {
    ...
    purpose: 'Apply all prior learning under pressure in varied, high-intensity SATs-style scenarios.',
    satsCoverage: [
      'number',
      'arithmetic',
      'fractions',
    ...
    contentDistribution: [
      { area: 'multi_step_reasoning', percentage: 40 },
      { area: 'arithmetic_application', percentage: 25 },
      { area: 'measure_data', percentage: 15 },
      { area: 'fractions_ratio', percentage: 10 },
      { area: 'mixed', percentage: 10 },
    ],
    crossGameReinforcement: [
      'By mid-tier, each challenge combines at least two domains.',
      'At mastery, challenges combine three or more domains in one flow.',
      'Examples include fraction + measure, ratio + multiplication, and data + subtraction.',
      'Skills from Islands 1-7 are reused naturally through context-driven decision loops.',
    ],
    designRules: [
      'Never feel like a test paper: avoid static problem screens and long written prompts.',
      'Reduce reading load; keep prompts short and rely on visual cues for context.',
      'Pressure must be real but fair: clear goals, rising speed, no unclear traps.',
      'All prior learning must transfer naturally into mixed-domain application.',
    ],
    successCriteria: [
      'Players handle mixed problems confidently.',
      'Players improve both speed and accuracy.',
      'Players reduce panic on multi-step challenge formats.',
      'Gameplay feels like mastery progression, not revision drill.',
    ],
    islandSkillTags: [
    ...
    miniGames: [
      ...
      },
      {
        ...
        role: 'strategy',
        gameplayRoles: ['strategy', 'mixed_mastery'],
        mechanicSummary: 'Solve chained linked problems where each resolved layer affects the next step upward.',
        curriculumObjectives: ['multi_step_reasoning', 'dependency_reasoning', 'cross_domain_transfer'],
        skillTags: ['MULTI_STEP_REASONING', 'MIXED_ARITHMETIC'],
        keySystems: ['linked-step state carry-over', 'dependency checks', 'progressive chain depth'],
        questionTypes: ['linked-step problem chains', 'dependency-based reasoning'],
        difficultyCurve: 'short linked chains -> longer dependencies -> high-load chain climbs',
        failureState: 'chain break',
        replayValue: 'generated dependency path sets',
      },
      {
        key: 'mixed_mastery',
        name: 'Mixed Mastery',
        role: 'mixed_mastery',
        gameplayRoles: ['mixed_mastery', 'fluency', 'pressure_timing'],
        mechanicSummary: 'Rapidly switch between mixed-domain challenge types while maintaining streak accuracy.',
        curriculumObjectives: ['cross_domain_recall', 'rapid_domain_switching', 'applied_reasoning'],
        skillTags: ['MULTI_STEP_REASONING', 'MIXED_ARITHMETIC', 'FRACTION_APPLICATION', 'RATIO_APPLICATION'],
        keySystems: ['domain switch queues', 'streak multipliers', 'timed response windows'],
        questionTypes: ['rapid mixed rounds', 'fast context switching'],
        difficultyCurve: 'two-domain bursts -> broad mixed sequences -> mastery-speed switching',
        failureState: 'streak break',
        replayValue: 'large mixed challenge pools',
      },
      {
        key: 'strategy_survival',
        name: 'Strategy Survival',
        role: 'pressure_timing',
        gameplayRoles: ['pressure_timing', 'mixed_mastery'],
        mechanicSummary: 'Survive continuous waves of mixed problems as complexity and pace escalate.',
        curriculumObjectives: ['transfer_under_pressure', 'endurance_reasoning', 'mixed_domain_application'],
        skillTags: ['MULTI_STEP_REASONING', 'MIXED_ARITHMETIC', 'DATA_APPLICATION', 'MEASURE_APPLICATION'],
        keySystems: ['wave escalation', 'no-pause endurance loop', 'fair pressure pacing'],
        questionTypes: ['mixed challenge waves', 'endurance decision sequences'],
      ...
      },
      {
        ...
        role: 'pressure_timing',
        gameplayRoles: ['pressure_timing', 'fluency', 'application'],
        mechanicSummary: 'Complete timed mixed challenge sets that mirror SATs pacing without test-paper framing.',
        curriculumObjectives: ['speed_and_confidence', 'timed_reasoning', 'exam_pacing_transfer'],
        skillTags: ['MULTI_STEP_REASONING', 'MIXED_ARITHMETIC', 'DATA_APPLICATION', 'MEASURE_APPLICATION'],
        keySystems: ['set timers', 'clear pacing feedback', 'progressive time compression'],
        questionTypes: ['timed mixed sets', 'pacing-focused challenge blocks'],
        difficultyCurve: 'generous time sets -> tighter windows -> high-pressure SATs-style pacing',
        failureState: 'time out',
        replayValue: 'rotating timed challenge packs',
      },
      {
        key: 'multi_step_marathon',
        name: 'Multi-Step Marathon',
        role: 'strategy',
        gameplayRoles: ['strategy', 'mixed_mastery', 'application'],
        mechanicSummary: 'Resolve longer-form layered problems that combine multiple domains in one run.',
        curriculumObjectives: ['advanced_problem_solving', 'layered_reasoning', 'combined_skill_application'],
        skillTags: [
          'MULTI_STEP_REASONING',
          'MIXED_ARITHMETIC',
          'FRACTION_APPLICATION',
        ...
        keySystems: ['layered objective steps', 'intermediate state dependencies', 'final synthesis checks'],
        questionTypes: ['long-form mixed reasoning', '3-plus-domain synthesis challenges'],
        difficultyCurve: 'medium chain depth -> long chain depth -> highest-complexity multi-domain runs',
        failureState: 'completion failure',
        replayValue: 'scenario-driven multi-domain variations',
      },
    ],
  },
];
