...
const IslandLevels: React.FC<IslandLevelsProps> = ({ island, player, onBack, onSelectLevel }) => {
  ...
  return (
    <div
      className="premium-page-root relative h-[100dvh] max-h-[100dvh] w-full overflow-y-auto overflow-x-hidden"
    ...
    >
      ...
      <div className="premium-page-content relative z-10 mx-auto flex min-h-full w-full max-w-4xl flex-col px-3 pb-4 pt-[calc(env(safe-area-inset-top)+0.5rem)] md:px-5 md:pb-6 md:pt-[calc(env(safe-area-inset-top)+0.65rem)]">
