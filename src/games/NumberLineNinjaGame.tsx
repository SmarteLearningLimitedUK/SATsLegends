        ...
        <div className="flex min-h-0 flex-1 flex-col items-center justify-start pt-0">
          ...
          <div className="relative mt-1 flex h-[30%] min-h-[200px] w-full max-w-[520px] shrink-0 translate-y-0 items-end justify-center">
            <div className="qa-enemy-cluster pointer-events-none relative mx-auto flex w-full max-w-[520px] flex-col items-center justify-end gap-3">
                <div className="w-[132px] self-center translate-y-[110px] rounded-lg border border-amber-200/35 bg-slate-900/76 p-1.5 shadow-[0_10px_20px_rgba(2,6,23,0.46)] sm:w-[150px]">
              ...
              <div className="relative flex w-full min-w-0 max-w-[280px] justify-center">
                ...
                <motion.div
                  className="relative w-[78%] max-w-[250px] translate-y-[72px] scale-[0.88] sm:w-full sm:max-w-[280px] sm:scale-100"
                  animate={{
                    y: [0, -5, 0],
