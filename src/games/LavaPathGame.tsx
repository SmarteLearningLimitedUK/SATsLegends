...
const LavaPathGame: React.FC<LavaPathGameProps> = ({
  levelId,
  avatarId,
  ...
  const [question, setQuestion] = useState<LavaPathQuestion>(() => resolveQuestion(resolvedLevel));
          ...
          >
            <div className="relative h-[clamp(5.1rem,9vw,7.4rem)] w-[clamp(5.1rem,9vw,7.4rem)]">
              ...
              <img
                ...
                className="relative z-10 h-full w-full object-contain object-bottom drop-shadow-[0_16px_22px_rgba(0,0,0,0.32)]"
