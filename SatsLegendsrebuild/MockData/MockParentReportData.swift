...
enum MockParentReportData {
    static let report = ParentReportSummary(
        ...
        skillMasteryOverview: [
            ...
            SkillProgress(id: UUID(), tag: .fractionAddSubtract, mastery: 0.61),
            SkillProgress(id: UUID(), tag: .dataInterpretation, mastery: 0.56)
        ],
        strengths: [.placeValue, .rounding, .angles],
        improvements: [.fractionEquivalence, .dataInterpretation, .conversion],
        recentActivity: [
        ...
        recommendedFocus: [.fractionAddSubtract, .conversion, .dataInterpretation]
    )
}
