...
enum MockWorldData {
    static let levels: [GameLevel] = [
        ...
        GameLevel(id: MockIDs.levelSky3, islandID: MockIDs.islandSky, name: "Fraction Drift", order: 3, skillTags: [.fractions], difficulty: 2, estimatedMinutes: 5, isUnlocked: true),
        ...
        GameLevel(id: MockIDs.levelForge2, islandID: MockIDs.islandForge, name: "Angle Arena", order: 2, skillTags: [.angles], difficulty: 3, estimatedMinutes: 6, isUnlocked: true),
        GameLevel(id: MockIDs.levelForge3, islandID: MockIDs.islandForge, name: "Measure Forge", order: 3, skillTags: [.area, .conversion], difficulty: 3, estimatedMinutes: 7, isUnlocked: false),
        ...
        GameLevel(id: MockIDs.levelVault2, islandID: MockIDs.islandVault, name: "Data Dungeon", order: 2, skillTags: [.data], difficulty: 4, estimatedMinutes: 7, isUnlocked: false),
        GameLevel(id: MockIDs.levelVault3, islandID: MockIDs.islandVault, name: "Boss Gate", order: 3, skillTags: [.fractions, .ratio], difficulty: 4, estimatedMinutes: 8, isUnlocked: false)
    ]
